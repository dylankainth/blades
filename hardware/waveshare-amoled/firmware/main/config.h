...
// Set to 1 if the badge hangs upside-down on the lanyard. (Software rotation on
// this panel: costs one extra internal draw buffer.)
#define DISPLAY_ROTATE_180   0

// Fixed AMOLED brightness, percent. The badge runs untethered from its own
// battery for hours and never dims or sleeps, so this is below maximum.
#define DISPLAY_BRIGHTNESS_PCT 65

// Touch fallback for the shake gesture: hold a finger on the screen this long.
#define TOUCH_SHAKE_HOLD_MS  1200
